...
import 'package:srchat1/feature/chat/widgets/custom_list_tile.dart';
              ...
              children: [
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 10),
                      Text(
                        "last seen ${lastSeenMessage(widget.user.lastSeen)} ago",
                ...
                CustomListTile(
                  ...
                  trailing: Switch(
                    ...
                    value: ProfilePage.mute,
                    onChanged: (value) {
                      setState(() {
                        ProfilePage.mute = true;
                      });
                    },
                  ),
                ),
                ...
                CustomListTile(
                  ...
                  trailing: Switch(
                    activeColor: Coloors.greenDark,
                    value: ProfilePage.media,
                    onChanged: (value) {
                      setState(() {
                        ProfilePage.media = true;
                      });
                    },
                  ),
                ),
